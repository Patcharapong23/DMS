      ...
      <nav className="max-w-{1366px} mx-auto h-{100px} flex justify-between items-center p-4">
        ...
        <ul className="hidden md:flex font-sembold text-1xl lg-text-[20px] text-[#707070]">
          <li className="mr-4 lg:mr-8 hover:text-[#E4965D] bg-clip-text border-b-2 border-transparent hover:border-[#E4965D] ">
            <Link href="/" className="flex items-center gap-2 text-lg"><FaHome/> Home</Link>
          </li>
          <li className="mr-4 lg:mr-8 hover:text-[#E4965D] bg-clip-text border-b-2 border-transparent hover:border-[#E4965D]">
            <Link href="/room_reservation" className="flex items-center gap-2 text-lg"><MdBedroomParent/>Reservation</Link>
          </li>
          <li className="mr-4 lg:mr-8 hover:text-[#E4965D] seticon">
            <h1 className="flex items-center gap-2 text-lg"><BsPersonCircle/></h1>
          </li>
        </ul>
        <div
        ...
        <div
          className={
            menuIcon
              ? "md:hidden absolute top-[100px] right-0 bottom-0 left-0 flex justify-center items-center w-full h-screen  bg-[#E4965D] text-black text-center ease-in-out duration-700"
              : "md:hidden absolute top-[100px] right-0 left-[-100%] flex justify-center items-center w-full h-screen bg-[#E4965D] text-black text-center ease-in-out duration-700"
          }
        >
